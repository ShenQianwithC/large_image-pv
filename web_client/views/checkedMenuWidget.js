...
wrap(HierarchyWidget, 'render', function (render) {
    render.call(this);
    console.log('(#####)large_image/../CheckedMenuWidget.js:wrap(HierarchyWidget)');
    if (!this.uploadAnnotation) {
        this.uploadAnnotation = () => {
            var cid = this.itemListView.checked[0],
                ...
                itemId = item.id,
                parentView = this;
                console.log('(#####)large_image/../CheckedMenuWidget.js:wrap(HierarchyWidget)cid=', cid);
                console.log('(#####)large_image/../CheckedMenuWidget.js:wrap(HierarchyWidget)itemId=', itemId);
                console.log('(#####)large_image/../CheckedMenuWidget.js:wrap(HierarchyWidget)parentView=', parentView);
            new UploadWidget({
